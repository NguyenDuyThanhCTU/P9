...
const openAccountInfo = ({ HeaderAdmin }: any) => {
  return (
    <>
      <div className="flex-[60%]">
        <div className="relative">
          ...
          <div>
            <div className="flex cursor-pointer hover:scale-110 duration-300   gap-3 bg-white text-black rounded-full items-center d:py-5 p:py-2  d:px-10 p:px-4 d:text-[28px] p:text-[13px] absolute top-0 d:left-32 p:left-0 shadow-lg">
              <CgExtensionAdd />
              <p>Thêm sản phẩm</p>
            </div>
          </div>
          ...
          <div>
            <div className="flex   cursor-pointer hover:scale-110 duration-300  gap-3 bg-white text-black rounded-full items-center d:py-5 p:py-2  d:px-10 p:px-4 d:text-[28px] p:text-[13px] absolute top-[40%] d:left-10 p:left-4 shadow-lg">
              <TfiLayoutSliderAlt />
              <p>Thêm Slide</p>
            </div>
          </div>
          <div>
            <div className="flex cursor-pointer hover:scale-110 duration-300   gap-3 bg-white text-black rounded-full items-center d:py-5 p:py-2  d:px-10 p:px-4 d:text-[28px] p:text-[13px] absolute top-0 d:right-10 p:right-0 shadow-lg">
              <MdOutlinePostAdd />
              <p>Thêm bài viết</p>
            </div>
          </div>
          ...
          <div>
            <div className="flex  cursor-pointer hover:scale-110 duration-300  gap-3 bg-white text-black rounded-full items-center d:py-5 p:py-2  d:px-10 p:px-4 d:text-[28px] p:text-[13px] absolute top-[40%] d:right-5 p:right-4 shadow-lg">
              <FaPhotoVideo />
              <p>Thêm Video</p>
            </div>
          </div>
